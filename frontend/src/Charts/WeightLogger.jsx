...
const WeightLogger = () => {
  ...
  const fetchWeightData = async () => {
    ...
    try {
      const response = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/Weight-charts?email=${userEmail}`);
  ...
  const handleWeightSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      await axios.post(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/Weight-charts`, {
        email: userEmail,
