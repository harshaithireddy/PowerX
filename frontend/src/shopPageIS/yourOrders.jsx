    ...
    useEffect(() => {
        ...
        const fetchOrders = async () => {
            ...
            try {
                ...
                const response = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/orders/${userEmail}`);
                ...
                if (Array.isArray(response.data)) {
                    ...
                    const itemsWithImages = await Promise.all(allItems.map(async (item) => {
                        ...
                        const productResponse = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/prod-get/${item.productName}`);
