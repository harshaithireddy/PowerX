...
const ExercisePage = () => {
    ...
    const fetchExercises = async () => {
      try {
        const response = await axios.get(
          `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/get-exercises-data`
        );
  ...
  const handleDoneClick = async (exerciseName, caloriesBurnt, event) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/exercise-done`,
        payload
      );
  ...
  const handleDeleteClick = async (exerciseName) => {
    ...
    try {
      const response = await axios.delete(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/delete-data`, {
        data: payload,
      });
