...
const FoodDietPage = () => {
  ...
  useEffect(() => {
    const fetchDiets = async () => {
      try {
        const response = await axios.get(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/get-all-diets`);
  ...
  const handleDoneClick = async (foodName, type, calories, event) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/food-taken`,
        payload
      );
  ...
  const handleDeleteClick = async (foodName) => {
    ...
    try {
      const response = await axios.delete(`${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL}/delete-food`, {
        data: payload,
      });
